...
$docenteImagen1 = $GLOBALS['PATH_DOCENTE'] . 'abelardoRodriguezLeon.webp';
...
$docenteImagen2 = $GLOBALS['PATH_DOCENTE'] . 'juliaGuadalupeTrujilloSalamanca.webp';
...
$docenteImagen3 = $GLOBALS['PATH_DOCENTE'] . 'bereniceLagunesPadilla.webp';
...
$docenteImagen4 = $GLOBALS['PATH_DOCENTE'] . 'rafaelRiveraLopez.webp';
...
$docenteImagen5 = $GLOBALS['PATH_DOCENTE'] . 'almeida.webp';
...
$docenteImagen6 = $GLOBALS['PATH_DOCENTE'] . 'noemiDelCarmenTenorioPrieto.webp';
      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption d-flex flex-column">
            <h1 class="mainTitle text-center font-bold m-2 shadow-text">Ingeniería en Sistemas Computacionales</h1>
  ...
  <div class="row px-2 g-0">
    ...
    <div class="lightSection col-lg-6 col-12 p-4">
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <div class="row g-0">
          <div class="col-12">
            <h2 class="sectionTitle text-center font-bold m-3">¿Por qué estudiar Ingeniería en Sistemas
              Computacionales?</h2>
