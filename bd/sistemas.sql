...
(1, 'Cálculo Diferencial', 'Calculo', '1', 'Plantea y resuelve problemas utilizando las definiciones de límite y derivada de funciones de una variable para la elaboración de modelos matemáticos aplicados.', 0, '...', '...'),
(2, 'Fundamentos de Programación', 'Programacion', '1', 'Aplica algoritmos y lenguajes de programación para diseñar e implementar soluciones a problemáticas del entorno.', 0, '...', '...'),
(3, 'Taller de Ética', 'Asignaturas Comunes', '1', 'Desarrolla conciencia sobre el significado y sentido de la Ética para orientar su comportamiento en el contexto social y profesional.', 0, '...', '...'),
(4, 'Matemáticas Discretas', 'Automatas', '1', 'Comprende y aplica los conceptos básicos de lógica matemática, relaciones, grafos y árboles para aplicarlos a modelos que resuelvan problemas computacionales.', 0, '...', '...'),
(5, 'Taller de Administración', 'Administracion', '1', 'Comprender y aplicar los procesos en las estructuras y funciones fundamentales de las organizaciones para contribuir sustantivamente con los procesos de planeación.', 0, '...', '...'),
(6, 'Fundamentos de Investigación', 'Investigacion', '1', 'Comprender y aplicar los procesos en las estructuras y funciones fundamentales de las organizaciones para contribuir sustantivamente con los procesos de planeación.', 0, '...', '...'),
(7, 'Cálculo Integral', 'Calculo', '2', 'Aplica la definición de integral y las técnicas de integración para resolver problemas de ingeniería.', 0, '...', '...'),
(8, 'Programación Orientada a Objetos', 'Programacion', '2', 'Aplica la programación orientada a objetos para resolver problemas reales y de ingeniería.', 0, '...', '...'),
(9, 'Contabilidad Financiera', 'Administracion', '2', 'Conoce, analiza e interpreta la información financiera para la toma de decisiones empresariales.', 0, '...', '...'),
(10, 'Química', 'Asignaturas Comunes', '2', 'Comprende la estructura de la materia y su relación con las propiedades físicas y químicas, así como a las técnicas requeridas para la construcción de equipos o sistemas electrónicos.', 0, '...', '...'),
(11, 'Álgebra Lineal', 'Matematicas Aplicada', '2', 'Aplica la definición de integral y las técnicas de integración para resolver problemas de ingeniería.', 0, '...', '...'),
(12, 'Probabilidad y Estadística', 'Estadistica', '2', 'Aplica la programación orientada a objetos para resolver problemas reales y de ingeniería.', 0, '...', '...'),
(13, 'Calculo Vectorial', 'Calculo', '3', 'Aplica los principios y técnicas básicas del cálculo vectorial para resolver problemas de ingeniería del entorno.', 0, '...', '...'),
(14, 'Estructura de datos', 'Programacion', '3', 'Conoce, comprende y aplica eficientemente estructuras de datos, métodos de ordenamiento y búsqueda para la optimización del rendimiento de soluciones a problemas del mundo real.', 0, '...', '...'),
(15, 'Cultura empresarial', 'Administracion', '3', 'Construye un plan de negocios para crear una empresa considerando el análisis de mercado, estudio técnico, organización, análisis financiero y estados financieros del proyecto.', 0, '...', '..'),
(16, 'Investigación de operaciones', 'Estadistica', '3', 'Formula soluciones óptimas para generar una mejor alternativa para la toma de decisiones aplicando conceptos de los modelos matemáticos, técnicas y algoritmos.', 0, '...', '...'),
(17, 'Desarrollo sustentable', 'Asignaturas Comunes', '3', 'Aplica una visión sustentable, en los ámbitos social, económico y ambiental que le permitirá evaluar y disminuir el impacto de la sociedad sobre el entorno, tomando en cuenta estrategias y considerando profesionalmente los valores ambientales.', 0, '...', '...'),
(18, 'Fisca general', 'Matematicas Aplicada', '3', 'Comprender los fenómenos físicos en los que intervienen fuerzas, movimiento, trabajo, energía, así como los principios básicos de Óptica y Termodinámica, además comprende y aplica las leyes y principios fundamentales de la electricidad y el magnetismo.', 0, '...', '...'),
(19, 'Ecuaciones diferenciales', 'Calculo', '4', 'Aplica los métodos de solución de ecuaciones diferenciales ordinarias para resolver problemas que involucran sistemas dinámicos que se presentan en la ingeniería.', 0, '...', '...'),
(20, 'Métodos numéricos', 'Matematicas Aplicada', '4', 'Aplica los métodos numéricos para resolver problemas científicos y de ingeniería utilizando la computadora.', 0, '...', '...'),
(21, 'Tópicos avanzados de programación', 'Programacion', '4', 'Desarrolla soluciones de software para resolver problemas en diversos contextos utilizando programación concurrente, acceso a datos, que soporten interfaz gráfica de usuario y consideren dispositivos móviles.', 0, '...', '...'),
(22, 'Fundamentos de bases de datos', 'Bases de datos', '4', 'Analiza requerimientos y diseña bases de datos para generar soluciones al tratamiento de información basándose en modelos y estándares', 0, '...', '...'),
(23, 'Simulación', 'Estadistica', '4', 'Analiza, modela, desarrolla y experimenta sistemas productivos y de servicios, reales o hipotéticos, a través de la simulación de eventos discretos, para dar servicio al usuario que necesite tomar decisiones, con el fin de describir con claridad su funcionamiento, aplicando herramientas matemáticas.', 0, '...', '...'),
(24, 'Principios eléctricos y aplicaciones digitales', 'Electronica', '4', 'Comprende y aplica las herramientas básicas de análisis de los sistemas analógicos y digitales para resolver problemas del ámbito computacional.', 0, '...', '...'),
(25, 'Graficación', 'Programacion', '5', 'Diseña e implementa modelos gráficos para enriquecer visualmente software diverso de aplicación en entornos de programación web, móvil y stand-alone, con base al trazo, manipulación, iluminación, sombreado y animación de objetos bidimensionales y tridimensionales.', 0, '...', '...'),
(26, 'Fundamentos de telecomunicaciones', 'Redes', '5', 'Analiza los componentes y la funcionalidad de diferentes sistemas de comunicación para evaluar las tecnologías utilizadas actualmente como parte de la solución de un proyecto de conectividad.', 0, '...', '...'),
(27, 'Taller de base de datos', 'Bases de datos', '5', 'Implementa bases de datos para apoyar la toma de decisiones considerando las reglas de negocio', 0, '...', '...'),
(28, 'Sistemas operativos', 'Sistemas operativos', '5', 'Aplica los paradigmas de diseño de los sistemas operativos actuales y emergentes, para el manejo de los recursos del sistema.', 0, '...', '...'),
(29, 'Fundamentos de ingeniería de software', 'Ingenieria', '5', 'Realiza el análisis de un proyecto de software, a partir de la identificación del modelo de negocios de la organización que permita alcanzar estándares y métricas de calidad.', 0, '...', '...'),
(30, 'Arquitectura de computadoras', 'Electronica', '5', 'Conoce diferentes modelos de arquitecturas y recomienda aplicaciones para resolver problemas de su entorno profesional.', 0, '...', '...'),
(31, 'Lenguajes y autómatas I', 'Automatas', '6', 'Define, diseña y programa las fases del analizador léxico y sintáctico de un traductor o compilador para preámbulo de la construcción de un compilador.', 0, '...', '...'),
(32, 'Redes de computadoras', 'Redes', '6', 'Diseña y elabora un proyecto de cableado estructurado aplicando normas y estándares vigentes para la solución de problemas de conectividad.', 0, '...', '...'),
(33, 'Administración de bases de datos', 'Bases de datos', '6', 'Instala, configura y administra un gestor de base de datos para el manejo de la información de una organización, optimizando la infraestructura computacional existente.', 0, '...', '...'),
(34, 'Taller de sistemas operativos', 'Sistemas operativos', '6', 'Conoce, identifica, selecciona y administra diferentes sistemas operativos con el fin de resolver problemáticas reales, así como aplicar procedimientos de interoperabilidad entre diferentes sistemas operativos.', 0, '...', '...'),
(35, 'Ingeniería de software', 'Ingenieria', '6', 'Desarrolla soluciones de software, considerando la metodología y herramientas para la elaboración de un proyecto aplicativo en diferentes escenarios.', 0, '...', '...'),
(36, 'Lenguajes de interfaz', 'Electronica', '6', 'Desarrollar software para establecer la interfaz hombre-máquina y máquina-máquina', 0, '...', '...'),
(37, 'Lenguajes y autómatas II', 'Automatas', '7', 'Implementa un compilador para un lenguaje específico considerando las etapas del mismo.', 0, '...', '...'),
(38, 'Conmutación y enrutamiento de redes de datos', 'Redes', '7', 'Diseña, instala y configura redes LAN inalámbricas aplicando normas y estándares vigentes para la solución de problemas de conectividad.', 0, '...', '...'),
(39, 'Taller de investigación I', 'Investigacion', '7', 'Elabora un protocolo de investigación en el que presenta soluciones científico-tecnológicas a problemáticas relacionadas con su campo profesional en diversos contextos.', 0, '...', '...'),
(40, 'Gestión de proyectos de software', 'Ingenieria', '7', 'Aplica metodologías e instrumentos, para garantizar la gestión adecuada de un proyecto de software.', 0, '...', '...'),
(41, 'Sistemas programables', 'Electronica', '7', 'Aplica microcontroladores en el diseño de interfaces hombre—máquina y máquina-máquina de sistemas programables.', 0, '...', '...'),
(42, 'Programación lógica funcional', 'Programacion', '8', 'Conoce los principios lógicos y funcionales de la programación para aplicarlos en la resolución de problemas.', 0, '...', '...'),
...
--
ALTER TABLE `materia`
  MODIFY `id_materia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
COMMIT;
